...
import com.belon.lib.SearchDeviceHelper;
import com.belon.lib.listener.SearchDeviceListener;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

public class SearchBleDevActivity extends AppCompatActivity implements
