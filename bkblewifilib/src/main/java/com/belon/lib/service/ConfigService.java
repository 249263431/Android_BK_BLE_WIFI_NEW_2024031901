...
import com.belon.lib.error.GattError;
import com.belon.lib.security.CRC;
import com.belon.util.BLog;
...
public  class ConfigService extends IntentService {
    ...
    public final static String BROADCAST_CONFIG_ERR_APP_CRC ="com.belon.bk3435.ble.BROADCAST_CONFIG_ERR_APP_CRC";
    ...
    @Override
    public void onDestroy() {//销毁时
        super.onDestroy();
        Log.d(TAG, "onDestroy...");
        try {
            broadcastLog(LOG_LEVEL_DEBUG,getClass().getSimpleName() + " onDestroy");
            String mDeviceAddress = getClass().getSimpleName() + " onDestroy";
...
//        }
        ...
        timeoutMilliscond = intent.getIntExtra(EXTRA_TIMEOUT,10*1000);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(final BluetoothGatt gatt, final int status, final int newState) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                } else if (newState == BluetoothGatt.STATE_DISCONNECTED) {//状态_断开连接
