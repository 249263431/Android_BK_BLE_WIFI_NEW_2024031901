...
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_CONECTED;
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_ERR_APP_CRC;
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_ERR_CON;
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_ERR_CON_PWD;
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_ERR_CON_TIMEOUT;
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_ERR_DEV_CRC;
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_SUCCESS;
import static com.belon.lib.service.ConfigService.BROADCAST_CONFIG_UUID_NOT_EXIST;
import static com.belon.lib.service.ConfigService.BROADCAST_LOG;
import static com.belon.lib.service.ConfigService.BROADCAST_LOG_EXTRA_EXCEPTION;
import static com.belon.lib.service.ConfigService.BROADCAST_LOG_EXTRA_LEVEL;
import static com.belon.lib.service.ConfigService.BROADCAST_LOG_EXTRA_MSG;
import static com.belon.lib.service.ConfigService.BROADCAST_LOG_EXTRA_TAG;
import static com.belon.lib.service.ConfigService.EXTRA_DEVICE_ADDRESS;
import static com.belon.lib.service.ConfigService.EXTRA_PASSWORD;
import static com.belon.lib.service.ConfigService.EXTRA_SSID;
import static com.belon.lib.service.ConfigService.EXTRA_TIMEOUT;
import static com.belon.lib.service.ConfigService.LOG_LEVEL_DEBUG;
import static com.belon.lib.service.ConfigService.LOG_LEVEL_ERROR;
import static com.belon.lib.service.ConfigService.LOG_LEVEL_INFO;
import static com.belon.lib.service.ConfigService.LOG_LEVEL_WARN;
...
public  class ConfigHelper {
    ...
    private static Intent aaaIntent;
...
//        if(TextUtils.isEmpty(deviceAddress) || ssidBytes == null || TextUtils.isEmpty(password)){
        ...
        if(TextUtils.isEmpty(deviceAddress) || ssidBytes == null){
            Log.d(TAG, "param error...");
            return false;
        }
        if(aaaIntent != null){
            context.stopService(aaaIntent);
        }
